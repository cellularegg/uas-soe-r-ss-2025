...
To ensure efficient training and avoid overfitting, early stopping was used with a patience threshold of 100 epochs. While most of the learning occurred within the first 200 epochs, the training continued until epoch 850 before early stopping restored the best weights based on validation loss. The final evaluation on the test set yielded an RMSE of 59,626, an MAE of 41,002, a MAPE of 13.96%, and an R² of 0.891. These results demonstrate good predictive performance and confirm that the model generalizes well to unseen data.

The following graphs illustrate the training and validation loss over epochs, showing convergence and stability in the model's learning process.
